...
//	Pick one of the following:
#define PROTOCOL_WIFI		false
#define PROTOCOL_BLUETOOTH	false
#define PROTOCOL_WIRED		true

//	Pick one of the following:
#define ROLE_IS_GETTER		true
#define ROLE_IS_PUTTER		false
...
#endif /* BOARD_TYPE */
#define NAME					(char*) "Serial Wired Receiver Tester"
...
#endif /* BOARD_TYPE */
#define NAME					(char*) "Bluetooth  Receiver Tester"
